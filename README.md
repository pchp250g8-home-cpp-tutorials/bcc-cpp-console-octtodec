OctToDec. C++ Tutorials. Embarcadero Rad Studio IDE. Simple Input/Output. Algorithms. Strings. Windows Platform. Console Application.
...
OctToDec. Занятия по C++. ИС Embarcadero Rad Studio. Простой Ввод/Вывод. Алгоритмы. Строки. Платформа Windows. Консольное приложение.
Консольное приложение написанное на языке программирования C++. 
Программа делает следующее:
  1. Просит пользователя ввести строку.
  2. Проверяет правильная ли строка была введена. Она должна быть короче 10 символов и содержать только цифры от 0 до 8.
...
Разработано в нитегрированной среде Embarcadero Rad Studio.
